...
public final class Page extends BodyBase implements Root {
	...
	/*
	 * String className = Types.UDF_PROPERTIES_ARRAY.toString(); BytecodeContext constr =
	 * bc.getConstructor(); GeneratorAdapter cga = constr.getAdapter();
	 * 
	 * // new UDFProperties Array
	 * 
	 * cga.visitVarInsn(Opcodes.ALOAD, 0); cga.push(1111); cga.newArray(Types.UDF_PROPERTIES);
