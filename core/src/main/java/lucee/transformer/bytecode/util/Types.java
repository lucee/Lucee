...
import lucee.runtime.type.ClosureMulti;
import lucee.runtime.type.ClosureSingle;
...
import lucee.runtime.type.LambdaMulti;
import lucee.runtime.type.LambdaSingle;
...
public final class Types {
    ...
    public static final Type CLOSURE_SINGLE = Type.getType(ClosureSingle.class);
    public static final Type CLOSURE_MULTI = Type.getType(ClosureMulti.class);
    public static final Type LAMBDA_SINGLE = Type.getType(LambdaSingle.class);
    public static final Type LAMBDA_MULTI = Type.getType(LambdaMulti.class);
