...
public final class TagParam extends TagBaseNoFinal {
	...
	private static final Method IS_EMPTY = new Method(
			"isEmpty",
			Types.BOOLEAN_VALUE,
			new Type[]{Types.STRING}
	);
	
	private static final Method CONSTR_STRING = new Method(
			"<init>",
			Types.VOID,
			new Type[]{Types.STRING}//
    		);
	
	private static final Method NULL = new Method(
			"NULL",
			Types.OBJECT,
			new Type[]{Types.PAGE_CONTEXT}//
    		);
	private static final Method GET_VARIABLE_EL = new Method(
			"getVariableEL",
			Types.OBJECT,
			new Type[]{Types.PAGE_CONTEXT,Types.STRING,Types.OBJECT}//
    		);
	private static final Method APPEND_OBJECT = new Method(
			"append",
			Types.STRING_BUILDER,
			new Type[]{Types.OBJECT}
			);
	private static final Method APPEND_STRING = new Method(
			"append",
			Types.STRING_BUILDER,
			new Type[]{Types.STRING}
			);
	private static final Method TO_STRING = new Method(
			"toString",
			Types.STRING,
			new Type[]{}
			);
	private static final Method SUB_PARAM = new Method(
			"subparam",
			Types.VOID,
			new Type[]{Types.STRING,Types.STRING,Types.OBJECT,Types.DOUBLE_VALUE,Types.DOUBLE_VALUE
					,Types.STRING,Types.INT_VALUE,Types.BOOLEAN_VALUE}
			);
	private static final Method T = new Method(
			"t",
			Types.VOID,
			new Type[]{Types.STRING,Types.STRING,Types.OBJECT,Types.DOUBLE_VALUE,Types.DOUBLE_VALUE
	...
	private double t(PageContext pc) throws ExpressionException {
		...
		if(NullSupportHelper.NULL(pc)==value) {
