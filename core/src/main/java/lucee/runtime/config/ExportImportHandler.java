...
public class ExportImportHandler {
	...
	public static void export(PageContext pc, ConfigServer cs, short types,String target, 
			boolean addOptionalArtifacts, 
			String regularMappingFilter, String componentMappingFilter, String customtagMappingFilter) throws IOException, PageException, ConverterException {
		...
		try {
			...
			CompressUtil.compress(
					CompressUtil.FORMAT_ZIP, 
					dir, 
					ResourceUtil.toResourceNotExisting(pc, target), 
					false, -1);
		}
		finally {
			dir.delete();
	...
	private static Map<String,Object> _export(ConfigImpl config, short types, Resource dir, String pathAppendix,
			boolean addOptionalArtifacts,
			String regularMappingFilter, String componentMappingFilter, String customtagMappingFilter) throws IOException {
		Map<String,Object> map=new HashMap<String, Object>();
	...
	private static List<Object> exportMapping(Mapping[] mappings, Resource dir, String pathAppendix,
