...
public class WSServerReflector implements WSServer {
	...
	public void doGet(PageContext pc, HttpServletRequest request, HttpServletResponse response, Component component) throws PageException {
		try {
			if(doGet==null) 
				doGet=clazz.getMethod("doGet", new Class[]{PageContext.class,HttpServletRequest.class, HttpServletResponse.class, Component.class});
	...
	public void doPost(PageContext pc, HttpServletRequest req, HttpServletResponse res, Component component) throws PageException {
		try {
			if(doPost==null) 
				doPost=clazz.getMethod("doPost", new Class[]{PageContext.class,HttpServletRequest.class, HttpServletResponse.class, Component.class});
	...
	public Object invoke(String name, Object[] args) throws PageException {
		try {
			if(invoke==null) 
				invoke=clazz.getMethod("invoke", new Class[]{String.class, Object[].class});
	...
	public void registerTypeMapping(Class clazz) {
		try {
			if(registerTypeMapping==null) 
				registerTypeMapping=clazz.getMethod("registerTypeMapping", new Class[]{Class.class});
