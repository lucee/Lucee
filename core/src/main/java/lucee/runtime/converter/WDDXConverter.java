...
public final class WDDXConverter extends ConverterSupport {
	 ...
	 * @param timeZone
	 * @param xmlConform
	 *            define if generated xml conform output or wddx conform output (wddx is not xml conform)
	 */
	...
	private String _serializeComponent(Component component, Set<Object> done) throws ConverterException {
		...
		try {
			...
			return goIn() + "<component md5=\"" + ComponentUtil.md5(component) + "\" name=\"" + XMLUtil.escapeXMLString(component.getAbsName()) + "\">" + sb
					+ "</component>";
		}
		catch (Exception e) {
	...
	private String _serializeQuery(Query query, Set<Object> done) throws ConverterException {
		...
		StringBuilder sb = new StringBuilder(goIn() + "<recordset rowCount=" + del + query.getRecordcount() + del + " fieldNames=" + del + fn + del + " type="
				+ del + "coldfusion.sql.QueryTable" + del + ">");
