...
public final class JSONConverter extends ConverterSupport {
	 ...
	 * @param charset
	 *            if set, characters not supported by the charset are escaped.
	 */
	...
	private void _serializeClass(PageContext pc, Set test, Class clazz, Object obj, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	...
	private void _serializeDateTime(DateTime dateTime, StringBuilder sb) {
		...
		/*
		 * try { sb.append(goIn()); sb.append("createDateTime("); sb.append(DateFormat.call(null,dateTime,"yyyy,m,d")); sb.append(' ');
		 * sb.append(TimeFormat.call(null,dateTime,"HH:mm:ss")); sb.append(')'); } catch (PageException e) { throw new ConverterException(e); }
		 */
	 ...
	 * @throws ConverterException
	 */
	private void _serializeArray(PageContext pc, Set test, Array array, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	 ...
	 * @throws ConverterException
	 */
	private void _serializeList(PageContext pc, Set test, List list, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	...
	private void _serializeArray(PageContext pc, Set test, Object[] arr, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	 ...
	 * @throws ConverterException
	 */
	private void _serializeMap(PageContext pc, Set test, Map map, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
		sb.append(goIn());
		sb.append("{");
	 ...
	 * @throws ConverterException
	 */
	private void _serializeComponent(PageContext pc, Set test, Component component, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	...
	private void _serializeUDF(PageContext pc, Set test, UDF udf, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
			throws ConverterException {
	...
	private void _serializeQuery(PageContext pc, Set test, Query query, StringBuilder sb, boolean serializeQueryByColumns, Set<Object> done)
		...
		if(serializeQueryByColumns) {
			...
			if(pc != null)
				upperCase = pc.getCurrentTemplateDialect() == CFMLEngine.DIALECT_CFML && ((ConfigWebImpl)pc.getConfig()).getDotNotationUpperCase();
