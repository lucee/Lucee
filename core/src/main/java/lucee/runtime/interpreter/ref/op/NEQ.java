 ...
 * imp operation
 */
public final class NEQ extends RefSupport implements Ref {
	 ...
	 * @param right
	 */
	public NEQ(Ref left, Ref right, boolean limited) {
		this.left = left;
		this.right = right;
	...
	public Object getValue(PageContext pc) throws PageException {
		...
		return OpUtil.compare(pc, left.getValue(pc), right.getValue(pc)) != 0 ? Boolean.TRUE : Boolean.FALSE;
	}
