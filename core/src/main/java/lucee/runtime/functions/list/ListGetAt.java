...
public final class ListGetAt extends BIF {
	...
	public static String call(PageContext pc, String list, Number posNumber) throws PageException {
		return call(pc, list, posNumber, ",", false);
	}

	public static String call(PageContext pc, String list, Number posNumber, String delimiter) throws PageException {
		return call(pc, list, posNumber, delimiter, false);
	}

	public static String call(PageContext pc, String list, Number posNumber, String delimiter, boolean includeEmptyFields) throws PageException {
