...
public final class ReplaceList extends BIF {
	...
	public static String call(PageContext pc , String str, String list1, String list2) {
		return _call(pc, str, list1, list2, ",", ",",false);
	}
	
	public static String call(PageContext pc , String str, String list1, String list2, String delimiter_list1) {
		return _call(pc, str, list1, list2, delimiter_list1, delimiter_list1,false);
	}
	...
	public static String call(PageContext pc , String str, String list1, String list2, String delimiter_list1, String delimiter_list2) {
		return _call(pc, str, list1, list2, delimiter_list1, delimiter_list2, false);
	}

	@Override
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		if(args.length==5) return _call(pc,Caster.toString(args[0]),Caster.toString(args[1]),Caster.toString(args[2]),Caster.toString(args[3]),Caster.toString(args[4]),false);
		if(args.length==4) return _call(pc,Caster.toString(args[0]),Caster.toString(args[1]),Caster.toString(args[2]),Caster.toString(args[3]),",",false);
		if(args.length==3) return _call(pc,Caster.toString(args[0]),Caster.toString(args[1]),Caster.toString(args[2]),",",",",false);
		throw new FunctionException(pc, "ReplaceList", 3, 5, args.length);
	}
	
	static String _call(PageContext pc , String str, String list1, String list2, String delimiter_list1, String delimiter_list2, boolean ignoreCase) {
