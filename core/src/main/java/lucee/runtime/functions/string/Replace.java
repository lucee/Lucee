...
public final class Replace extends BIF {
	...
	private static String _call(PageContext pc , String str, String sub1, Object sub2, boolean firstOnly) throws PageException {
		if (StringUtil.isEmpty(sub1))
			return str;
		if(Decision.isSimpleValue(sub2))
			return StringUtil.replace(str, sub1, Caster.toString(sub2), firstOnly,false);
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
    	...
    	if(args.length==3)
			return call(pc, Caster.toString(args[0]), args[1],args[2]);
    	if(args.length==4)
			return call(pc, Caster.toString(args[0]), args[1],args[2],Caster.toString(args[3]));
