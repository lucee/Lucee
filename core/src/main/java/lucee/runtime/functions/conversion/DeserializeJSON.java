...
public final class DeserializeJSON implements Function {
	...
	private static final long serialVersionUID = -286845653412130874L;
	...
	public static Object call(PageContext pc, String JSONVar, boolean strictMapping) throws PageException {
		if (StringUtil.isEmpty(JSONVar, true)) {
			...
			else throw new FunctionException(pc, "DeserializeJSON", 1, "JSONVar", "input value cannot be empty string.", "Must be the valid JSON string");
		}
