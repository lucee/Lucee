...
public final class CreateDateTime extends BIF {
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		if(args.length==8)return _call(pc,Caster.toIntValue(args[0]),Caster.toIntValue(args[1]),Caster.toIntValue(args[2]),Caster.toIntValue(args[3]),Caster.toIntValue(args[4]),Caster.toIntValue(args[5]),Caster.toIntValue(args[6]),Caster.toTimeZone(args[7]));
		if(args.length==7)return _call(pc,Caster.toIntValue(args[0]),Caster.toIntValue(args[1]),Caster.toIntValue(args[2]),Caster.toIntValue(args[3]),Caster.toIntValue(args[4]),Caster.toIntValue(args[5]),Caster.toIntValue(args[6]),pc.getTimeZone());
		if(args.length==6)return _call(pc,Caster.toIntValue(args[0]),Caster.toIntValue(args[1]),Caster.toIntValue(args[2]),Caster.toIntValue(args[3]),Caster.toIntValue(args[4]),Caster.toIntValue(args[5]),0,pc.getTimeZone());
		if(args.length==5)return _call(pc,Caster.toIntValue(args[0]),Caster.toIntValue(args[1]),Caster.toIntValue(args[2]),Caster.toIntValue(args[3]),Caster.toIntValue(args[4]),0,0,pc.getTimeZone());
		if(args.length==4)return _call(pc,Caster.toIntValue(args[0]),Caster.toIntValue(args[1]),Caster.toIntValue(args[2]),Caster.toIntValue(args[3]),0,0,0,pc.getTimeZone());
