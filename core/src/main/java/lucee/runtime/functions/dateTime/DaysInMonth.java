...
public final class DaysInMonth extends BIF {

	private static final long serialVersionUID = 1383750689865240892L;
	...
	private static Number _call(PageContext pc, DateTime date, TimeZone tz) {
		return Caster.toNumber(pc, DateTimeUtil.getInstance().getDaysInMonth(tz, date));
	}
