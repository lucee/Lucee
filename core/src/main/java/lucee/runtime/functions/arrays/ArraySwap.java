...
public final class ArraySwap extends BIF {
	...
	public static boolean call(PageContext pc, Array array, Number number, Number number2) throws ExpressionException {
		ArrayUtil.swap(array, Caster.toIntValue(number), Caster.toIntValue(number2));
		return true;
	}
