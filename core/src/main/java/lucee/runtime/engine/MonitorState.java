...
public class MonitorState {
	...
	public static class BlockedThread {
		...
		public String getMessage() {
			...
			StringBuilder sb= new StringBuilder(possibleBlockers.size()>1?
					"The thread is possibly blocked by the following threads:\n":
			...
			while(it.hasNext()) {
				e = it.next();
				sb.append(MonitorState.toString(e.getValue()))
				.append("\n");
		...
		public String toString() {
			StringBuilder sb= new StringBuilder()
			.append("Blocked:\n")
			.append(MonitorState.toString(blockedST))
			.append("\nPossible Blockers:\n");
