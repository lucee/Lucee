...
class UNIXSocketImpl extends SocketImpl {
	...
	private final class AFUNIXInputStream extends InputStream {
		...
		public int read(byte[] buf, int off, int len) throws IOException {
			...
			try {
				...
				throw (IOException) new IOException(e.getMessage() + " at " + UNIXSocketImpl.this.toString())
						.initCause(e);
			}
		}
	...
	public String toString() {
		return super.toString() + "[fd=" + fd + "; file=" + this.socketFile + "; connected=" + connected + "; bound="
				+ bound + "]";
	}
