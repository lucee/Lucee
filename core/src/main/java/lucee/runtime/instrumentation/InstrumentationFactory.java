...
public class InstrumentationFactory {
    ...
    /*private static String createAgentJar(Config config) throws IOException {
        ...
        try {
	        zis = new ZipInputStream( IOUtil.toBufferedInputStream(InfoImpl.class.getResourceAsStream("/resource/lib/lucee-external-agent.jar")) );
	        ...
	        writer.println("Agent-Class: lucee.runtime.instrumentation.ExternalAgent");
