...
/**
 * This class represents an element type in the schema. An element type has a name, a content model
 * vector, a member-of vector, a flags vector, default attributes, and a schema to which it belongs.
 * 
 * @see Schema
 */
...
public class ElementType {
	...
	/**
	 * Construct an ElementType: but it's better to use Schema.element() instead. The content model,
	 * member-of, and flags vectors are specified as ints.
	 * 
	 * @param name The element type name
	 * @param model ORed-together bits representing the content models allowed in the content of this
	 *            element type
	 * @param memberOf ORed-together bits representing the content models to which this element type
	 *            belongs
	...
	/**
	 * Return a namespace name from a Qname. The attribute flag tells us whether to return an empty
	 * namespace name if there is no prefix, or use the schema default instead.
	 * 
	...
	/**
	 * Returns the default attributes associated with this element type. Attributes of type CDATA that
	 * don't have default values are typically not included. Other attributes without default values
	 * have an internal value of <tt>null</tt>. The return value is an AttributesImpl to allow the
	...
	/**
	 * Returns true if this element type can contain another element type. That is, if any of the models
	 * in this element's model vector match any of the models in the other element type's member-of
	 * vector.
	 * 
	...
	/**
	 * Sets an attribute and its value into an AttributesImpl object. Attempts to set a namespace
