...
/**
 * The internal representation of an actual element (not an element type). An Element has an element
 * type, attributes, and a successor Element for use in constructing stacks and queues of Elements.
 * 
 * @see ElementType
 * @see AttributesImpl
 */
public class Element {
	...
	/**
	 * Return the attributes as an AttributesImpl object. Returning an AttributesImpl makes the
	 * attributes mutable.
	 * 
	...
	/**
	 * Return true if the type of this element can contain the type of another element. Convenience
	 * method.
	 * 
	...
	/**
	 * Make this element anonymous. Remove any <tt>id</tt> or <tt>name</tt> attribute present in the
	...
	/**
	 * Clean the attributes of this element. Attributes with null name (the name was ill-formed) or null
	 * value (the attribute was present in the element type but not in this actual element) are removed.
	 */
	...
	/**
	 * Force this element to preclosed status, meaning that an end-tag has been seen but the element
	 * cannot yet be closed for structural reasons.
	 */
