...
public class RSA {
	...
	private static byte[] encrypt(byte[] data, PrivateKey privateKeyToEncrypt) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
	...
	private static byte[] decrypt(byte[] data, PublicKey publicKeyToDecrypt, int offset) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
