...
public final class Coder {
	 ...
	 */
	public static byte[] decode(String type, String value, boolean precise) throws CoderException {
	 ...
	 * @throws CoderException
	 */
	public static byte[] decode(short type, String value, boolean precise) throws CoderException {
		if (type == ENCODING_UU) return UUCoder.decode(value);
		else if (type == ENCODING_HEX) return HexCoder.decode(value);
		else if (type == ENCODING_BASE64) return Base64Coder.decode(value, precise);
