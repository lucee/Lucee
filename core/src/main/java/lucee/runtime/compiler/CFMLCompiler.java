...
public interface CFMLCompiler {
     ...
     * 
     * @throws IOException / public abstract byte[] compile(ConfigImpl config, PageSource source,
     * TagLib[] tld, FunctionLib[] fld, Resource classRootDir) throws TemplateException, IOException,
