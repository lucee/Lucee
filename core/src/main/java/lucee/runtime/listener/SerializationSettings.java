...
public class SerializationSettings {
	...
	public static SerializationSettings toSerializationSettings(Struct sct) {
		return new SerializationSettings(
				Caster.toBooleanValue(sct.get("preserveCaseForStructKey",null),true),
				Caster.toBooleanValue(sct.get("preserveCaseForQueryColumn",null),false),
				toSerializeQueryAs(Caster.toString(sct.get("serializeQueryAs",null),null))
		);
	}
