...
public class LambdaMulti extends EnvUDFMulti implements Lambda {

    public LambdaMulti() {// used for externalize
	super();
    }

    public LambdaMulti(UDFProperties properties) {
	super(properties);
    }

    private LambdaMulti(UDFProperties properties, Variables variables) { // used for duplicate
	...
	LambdaMulti lam = new LambdaMulti(properties, variables);// TODO duplicate variables as well?
