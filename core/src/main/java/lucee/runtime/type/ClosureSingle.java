...
public class ClosureSingle extends EnvUDFSingle implements Closure {

    public ClosureSingle() {// used for externalize
	super();
    }

    public ClosureSingle(UDFProperties properties) {
	super(properties);
    }

    private ClosureSingle(UDFProperties properties, Variables variables) { // used for duplicate
	...
	ClosureSingle clo = new ClosureSingle(properties, variables);// TODO duplicate variables as well?
