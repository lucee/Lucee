...
public class ClosureMulti extends EnvUDFMulti implements Closure {

    public ClosureMulti() {// used for externalize
	super();
    }

    public ClosureMulti(UDFProperties properties) {
	super(properties);
    }

    private ClosureMulti(UDFProperties properties, Variables variables) { // used for duplicate
	...
	ClosureMulti clo = new ClosureMulti(properties, variables);// TODO duplicate variables as well?
