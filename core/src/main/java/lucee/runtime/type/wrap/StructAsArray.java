...
public class StructAsArray extends ArraySupport implements Array,List {
	...
	public static Array toArray(Struct sct) throws ExpressionException {
        ...
        while(it.hasNext()) {
        	...
        	if(!Decision.isInteger(k.getString()))
        		throw new ExpressionException("can't cast struct to an array, key ["+k.getString()+"] is not a number");
        }
	...
	public Object set(String k, Object value) throws PageException {
    	if(!Decision.isInteger(k))
    		throw new ExpressionException("can't cast struct to an array, key ["+k+"] is not a number");
