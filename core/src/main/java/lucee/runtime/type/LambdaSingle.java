...
public class LambdaSingle extends EnvUDFSingle implements Lambda {

    public LambdaSingle() {// used for externalize
	super();
    }

    public LambdaSingle(UDFProperties properties) {
	super(properties);
    }

    private LambdaSingle(UDFProperties properties, Variables variables) { // used for duplicate
	...
	LambdaSingle lam = new LambdaSingle(properties, variables);// TODO duplicate variables as well?
