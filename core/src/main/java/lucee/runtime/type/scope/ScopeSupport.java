...
public abstract class ScopeSupport extends StructImpl implements Scope {
	...
	protected ExpressionException invalidKey(String key) {
		return new ExpressionException(
				"variable [" + key + "] doesn't exist in " + StringUtil.ucFirst(name) + " Scope (keys:" + ListUtil.arrayToList(keys(), ",") + ")");
	}
	...
	/*
	 * private String decode(Object value,String encoding) throws UnsupportedEncodingException { return URLDecoder.decode(new
