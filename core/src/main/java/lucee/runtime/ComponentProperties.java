...
public class ComponentProperties implements Serializable {
	...
	public ComponentProperties(String dspName,String extend,String implement,String hint, Boolean output, String callPath, 
			boolean realPath,boolean _synchronized,Class javaAccessClass,boolean persistent,boolean accessors,int modifier,Struct meta) {
	...
	public ComponentProperties duplicate() {
		ComponentProperties cp= new ComponentProperties(dspName,extend,implement,hint,output,callPath,realPath,_synchronized,javaAccessClass,persistent,accessors,modifier,meta);
