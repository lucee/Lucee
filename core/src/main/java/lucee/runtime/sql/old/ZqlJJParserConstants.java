...
public interface ZqlJJParserConstants
{
    ...
    /*public static final String tokenImage[] = {
        "<EOF>", "\" \"", "\"\\t\"", "\"\\r\"", "\"\\n\"", 
        "\"NEVER_USE_AVG\"", "\"NEVER_USE_BETWEEN\"", "\"NEVER_USE_BINARY_INTEGER\"", "\"NEVER_USE_BOOLEAN\"", "\"NEVER_USE_BY\"", 
        "\"NEVER_USE_CHAR\"", "\"NEVER_USE_COMMENT\"", "\"NEVER_USE_COMMIT\"", "\"NEVER_USE_CONNECT\"", "\"NEVER_USE_COUNT\"", 
        "\"NEVER_USE_DATE\"", "\"NEVER_USE_DELETE\"", "\"NEVER_USE_DESC\"", "\"NEVER_USE_DISTINCT\"", "\"NEVER_USE_EXCLUSIVE\"", 
        "\"NEVER_USE_EXISTS\"", "\"NEVER_USE_EXIT\"", "\"NEVER_USE_FLOAT\"", "\"NEVER_USE_FOR\"", "\"NEVER_USE_FROM\"", 
        "\"NEVER_USE_GROUP\"", "\"NEVER_USE_HAVING\"", "\"NEVER_USE_IN\"", "\"NEVER_USE_INSERT\"", "\"NEVER_USE_INTEGER\"", 
        "\"NEVER_USE_INTERSECT\"", "\"NEVER_USE_INTO\"", "\"NEVER_USE_IS\"", "\"NEVER_USE_LIKE\"", "\"NEVER_USE_LOCK\"", 
        "\"NEVER_USE_MAX\"", "\"NEVER_USE_MIN\"", "\"NEVER_USE_MINUS\"", "\"NEVER_USE_MODE\"", "\"NEVER_USE_NATURAL\"", 
        "\"NEVER_USE_NOT\"", "\"NEVER_USE_NOWAIT\"", "\"NEVER_USE_NULL\"", "\"NEVER_USE_NUMBER\"", "\"NEVER_USE_OF\"", 
        "\"NEVER_USE_ONLY\"", "\"NEVER_USE_OR\"", "\"NEVER_USE_ORDER\"", "\"NEVER_USE_PRIOR\"", "\"NEVER_USE_QUIT\"", 
        "\"NEVER_USE_READ\"", "\"NEVER_USE_REAL\"", "\"NEVER_USE_ROLLBACK\"", "\"NEVER_USE_ROW\"", "\"NEVER_USE_SELECT\"", 
        "\"NEVER_USE_SET\"", "\"NEVER_USE_SHARE\"", "\"NEVER_USE_SMALLINT\"", "\"NEVER_USE_START\"", "\"NEVER_USE_SUM\"", 
        "\"NEVER_USE_TABLE\"", "\"NEVER_USE_TRANSACTION\"", "\"NEVER_USE_UNION\"", "\"NEVER_USE_UPDATE\"", "\"NEVER_USE_VALUES\"", 
        "\"NEVER_USE_VARCHAR2\"", "\"NEVER_USE_VARCHAR\"", "\"NEVER_USE_WHERE\"", "\"NEVER_USE_WITH\"", "\"NEVER_USE_WORK\"", 
        "\"NEVER_USE_WRITE\"", "<S_NUMBER>", "<FLOAT>", "<INTEGER>", "<DIGIT>", 
        "<LINE_COMMENT>", "<MULTI_LINE_COMMENT>", "<S_IDENTIFIER>", "<LETTER>", "<SPECIAL_CHARS>", "<S_BIND>", "<S_CHAR_LITERAL>", 
        "<S_QUOTED_IDENTIFIER>", "\"(\"", "\",\"", 
        "\")\"", "\";\"", "\"=\"", "\".\"", "\"!=\"", "\"#\"", "\"<>\"", "\">\"", "\">=\"", "\"<\"", 
        "\"<=\"", "\"+\"", "\"-\"", "\"*\"", "\".*\"", "\"?\"", "\"||\"", "\"/\"", "\"**\""
    };*/
    public static final String tokenImage[] = {
        "<EOF>", "\" \"", "\"\\t\"", "\"\\r\"", "\"\\n\"", "\"ALL\"", "\"AND\"", "\"ANY\"", "\"AS\"", "\"ASC\"", 
        "\"AVG\"", "\"BETWEEN\"", "\"BINARY_INTEGER\"", "\"BOOLEAN\"", "\"BY\"", "\"CHAR\"", "\"COMMENT\"", "\"COMMIT\"", "\"CONNECT\"", "\"COUNT\"", 
        "\"DATE\"", "\"DELETE\"", "\"DESC\"", "\"DISTINCT\"", "\"EXCLUSIVE\"", "\"EXISTS\"", "\"EXIT\"", "\"FLOAT\"", "\"FOR\"", "\"FROM\"", 
        "\"GROUP\"", "\"HAVING\"", "\"IN\"", "\"INSERT\"", "\"INTEGER\"", "\"INTERSECT\"", "\"INTO\"", "\"IS\"", "\"LIKE\"", "\"LOCK\"", 
        "\"MAX\"", "\"MIN\"", "\"MINUS\"", "\"MODE\"", "\"NATURAL\"", "\"NOT\"", "\"NOWAIT\"", "\"NULL\"", "\"NUMBER\"", "\"OF\"", 
        "\"ONLY\"", "\"OR\"", "\"ORDER\"", "\"PRIOR\"", "\"QUIT\"", "\"READ\"", "\"REAL\"", "\"ROLLBACK\"", "\"ROW\"", "\"SELECT\"", 
        "\"SET\"", "\"SHARE\"", "\"SMALLINT\"", "\"START\"", "\"SUM\"", "\"TABLE\"", "\"TRANSACTION\"", "\"UNION\"", "\"UPDATE\"", "\"VALUES\"", 
        "\"VARCHAR2\"", "\"VARCHAR\"", "\"WHERE\"", "\"WITH\"", "\"WORK\"", "\"WRITE\"", "<S_NUMBER>", "<FLOAT>", "<INTEGER>", "<DIGIT>", 
        "<LINE_COMMENT>", "<MULTI_LINE_COMMENT>", "<S_IDENTIFIER>", "<LETTER>", "<SPECIAL_CHARS>", "<S_BIND>", "<S_CHAR_LITERAL>", "<S_QUOTED_IDENTIFIER>", "\"(\"", "\",\"", 
        "\")\"", "\";\"", "\"=\"", "\".\"", "\"!=\"", "\"#\"", "\"<>\"", "\">\"", "\">=\"", "\"<\"", 
        "\"<=\"", "\"+\"", "\"-\"", "\"*\"", "\".*\"", "\"?\"", "\"||\"", "\"/\"", "\"**\""
    };
