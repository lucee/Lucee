...
public final class HSQLDBHandler {
	 ...
	 */
	private static void createTable(Connection conn, PageContext pc, String dbTableName, String cfQueryName, boolean doSimpleTypes) throws SQLException, PageException {
