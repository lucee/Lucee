...
public final class SQLCaster {
			...
			switch (type) {
				...
				default:
					if(value instanceof DateTime)
						return new Date(Caster.toDate(value, null).getTime());
					if(value instanceof lucee.runtime.type.Array)
						return Caster.toList(value);
					if(value instanceof lucee.runtime.type.Struct)
						return Caster.toMap(value);
	...
	public static void setValue(PageContext pc, TimeZone tz, PreparedStatement stat, int parameterIndex, SQLItem item)
			throws PageException, SQLException, DatabaseException {
	...
	/*
	 * private static String toString(Clob clob) throws SQLException, IOException { Reader in = clob.getCharacterStream(); StringBuilder buf = new
	 * StringBuilder(); for(int c=in.read();c != -1;c = in.read()) { buf.append((char)c); } return buf.toString(); }
	 */
	 ...
	 */
	/*
	 * public static int cfSQLTypeToIntType(String strType) throws DatabaseException { strType=strType.toUpperCase().trim();
	 * 
	 * if(strType.equals("CF_SQL_ARRAY")) return Types.ARRAY; else if(strType.equals("CF_SQL_BIGINT")) return Types.BIGINT; else
	 * if(strType.equals("CF_SQL_BINARY")) return Types.BINARY; else if(strType.equals("CF_SQL_BIT")) return Types.BIT; else if(strType.equals("CF_SQL_BLOB"))
	 * return Types.BLOB; else if(strType.equals("CF_SQL_BOOLEAN")) return Types.BOOLEAN; else if(strType.equals("CF_SQL_CHAR")) return Types.CHAR; else
	 * if(strType.equals("CF_SQL_CLOB")) return Types.CLOB; else if(strType.equals("CF_SQL_DATALINK")) return Types.DATALINK; else
	 * if(strType.equals("CF_SQL_DATE")) return Types.DATE; else if(strType.equals("CF_SQL_DISTINCT")) return Types.DISTINCT; else
	 * if(strType.equals("CF_SQL_DECIMAL")) return Types.DECIMAL; else if(strType.equals("CF_SQL_DOUBLE")) return Types.DOUBLE; else
	 * if(strType.equals("CF_SQL_FLOAT")) return Types.FLOAT; else if(strType.equals("CF_SQL_IDSTAMP")) return CFTypes.IDSTAMP; else
	 * if(strType.equals("CF_SQL_INTEGER")) return Types.INTEGER; else if(strType.equals("CF_SQL_INT")) return Types.INTEGER; else
	 * if(strType.equals("CF_SQL_LONGVARBINARY"))return Types.LONGVARBINARY; else if(strType.equals("CF_SQL_LONGVARCHAR"))return Types.LONGVARCHAR; else
	 * if(strType.equals("CF_SQL_MONEY")) return Types.DOUBLE; else if(strType.equals("CF_SQL_MONEY4")) return Types.DOUBLE; else
	 * if(strType.equals("CF_SQL_NUMERIC")) return Types.NUMERIC; else if(strType.equals("CF_SQL_NULL")) return Types.NULL; else
	 * if(strType.equals("CF_SQL_REAL")) return Types.REAL; else if(strType.equals("CF_SQL_REF")) return Types.REF; else if(strType.equals("CF_SQL_REFCURSOR"))
	 * return CFTypes.CURSOR; else if(strType.equals("CF_SQL_OTHER")) return Types.OTHER; else if(strType.equals("CF_SQL_SMALLINT")) return Types.SMALLINT; else
	 * if(strType.equals("CF_SQL_STRUCT")) return Types.STRUCT; else if(strType.equals("CF_SQL_TIME")) return Types.TIME; else
	 * if(strType.equals("CF_SQL_TIMESTAMP")) return Types.TIMESTAMP; else if(strType.equals("CF_SQL_TINYINT")) return Types.TINYINT; else
	 * if(strType.equals("CF_SQL_VARBINARY")) return Types.VARBINARY; else if(strType.equals("CF_SQL_VARCHAR")) return Types.VARCHAR; else
	 * if(strType.equals("CF_SQL_NVARCHAR")) return Types.NVARCHAR; else if(strType.equals("CF_SQL_VARCHAR2")) return CFTypes.VARCHAR2;
	 * 
	 * 
	...
	public static int toSQLType(String strType) throws DatabaseException {
		...
		if(strType.startsWith("CF_SQL_"))
			strType = strType.substring(7);
		if(strType.startsWith("SQL_"))
		...
		if(strType.length() > 2) {
			...
			if(first == 'A') {
				...
				if(strType.equals("CLOB"))
					return Types.CLOB;
				else if(strType.equals("CHAR"))
					return Types.CHAR;
				else if(strType.equals("CLOB"))
					return Types.CLOB;
				else if(strType.equals("CURSOR"))
					return CFTypes.CURSOR;
			}
			else if(first == 'D') {
				if(strType.equals("DATALINK"))
					return Types.DATALINK;
				else if(strType.equals("DATE"))
					return Types.DATE;
				else if(strType.equals("DISTINCT"))
					return Types.DISTINCT;
				else if(strType.equals("DECIMAL"))
				...
				if(strType.equals("IDSTAMP"))
					return CFTypes.IDSTAMP;
				...
				if(strType.equals("LONGVARBINARY"))
					return Types.LONGVARBINARY;
				else if(strType.equals("LONGVARCHAR"))
					return Types.LONGVARCHAR;
			}
			else if(first == 'M') {
				if(strType.equals("MONEY"))
					return Types.DOUBLE;
				else if(strType.equals("MONEY4"))
					return Types.DOUBLE;
			}
			else if(first == 'N') {
				if(strType.equals("NUMERIC"))
					return Types.NUMERIC;
				else if(strType.equals("NUMBER"))
					return Types.NUMERIC;
				else if(strType.equals("NULL"))
					return Types.NULL;
				else if(strType.equals("NCHAR"))
					return Types.NCHAR;
				else if(strType.equals("NCLOB"))
					return Types.NCLOB;
				else if(strType.equals("NVARCHAR"))
				...
				if(strType.equals("OTHER"))
					return Types.OTHER;
				else if("OBJECT".equals(strType))
					return Types.OTHER;
			}
			else if(first == 'R') {
				if(strType.equals("REAL"))
					return Types.REAL;
				else if(strType.equals("REF"))
					return Types.REF;
				else if(strType.equals("REFCURSOR"))
					return CFTypes.CURSOR;
			}
			else if(first == 'S') {
				if(strType.equals("SMALLINT"))
					return Types.SMALLINT;
				else if(strType.equals("STRUCT"))
					return Types.STRUCT;
				else if(strType.equals("STRING"))
					return Types.VARCHAR;
				else if(strType.equals("SQLXML"))
					return Types.SQLXML;
			}
			else if(first == 'T') {
				...
				else if(strType.equals("TINYINT"))
					return Types.TINYINT;
			}
			else if(first == 'V') {
				if(strType.equals("VARBINARY"))
					return Types.VARBINARY;
				else if(strType.equals("VARCHAR"))
					return Types.VARCHAR;
				else if(strType.equals("VARCHAR2"))
					return CFTypes.VARCHAR2;
			}
		}
