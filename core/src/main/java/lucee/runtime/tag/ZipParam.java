...
public final class ZipParam extends TagImpl {
	...
	public void setSource(String strSource) throws PageException {
		...
		if (source == null || !source.exists()) source = ResourceUtil.toResourceExisting(pageContext, strSource);
	}
	...
	public int doStartTag() throws PageException {
		...
		else throw new ApplicationException("invalid attribute combination");
	...
	private void notAllowed(String combi, String name, Object value) throws ApplicationException {
		if (value != null) throw new ApplicationException("attribute [" + name + "] is not allowed in combination with attribute(s) [" + combi + "]");
	}

	@Override
	public void required(String combi, String name, Object value) throws ApplicationException {
		if (value == null) throw new ApplicationException("attribute [" + name + "] is required in combination with attribute(s) [" + combi + "]");
	}
