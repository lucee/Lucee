...
public final class Log extends TagImpl {
	...
	public int doStartTag() throws PageException {
		...
		if (file == null) {
			...
			/*
			 * if (tmp instanceof LogAdapter) { LogAdapter la = (LogAdapter) tmp; Logger ll = la.getLogger(); if
			 * (ll instanceof org.apache.logging.log4j.core.Logger) { Map<String, Appender> appenders =
			 * ((org.apache.logging.log4j.core.Logger) ll).getAppenders(); if (appenders != null) { for
			 * (Appender a: appenders.values()) { if (a instanceof ResourceAppender) { logger = tmp; break; } }
			 * } } }
			 */
