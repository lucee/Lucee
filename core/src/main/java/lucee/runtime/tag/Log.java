		...
		if (file == null) {
			...
			if (logger == null) {
				...
				if ("console".equalsIgnoreCase(log))
					...
					String msg = ExceptionUtil.similarKeyMessage(keys, log, "attribute log", "log names", null);
					String detail = ExceptionUtil.similarKeyMessage(keys, log, "attribute log", "log names", null,true);
