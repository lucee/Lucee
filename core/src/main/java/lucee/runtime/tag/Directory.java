...
public final class Directory extends TagImpl {
    ...
    public int doStartTag() throws PageException {
        ...
        if (action.equals("list")) {
            ...
            actionCreate(pageContext, directory, serverPassword, createPath, mode, acl, storage, nameconflict);
            ...
            actionRename(pageContext, directory, strNewdirectory, serverPassword, createPath, acl, storage);
    ...
    public static Object actionList(PageContext pageContext, Resource directory, String serverPassword, int type,
        ...
        Query query = new QueryImpl(
                namesOnly ? new String[]{"name"} : names,
                namesOnly ? new String[]{"VARCHAR"} : types,
                0, "query");
