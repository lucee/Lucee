 ...
 */
public class ConcurrentHashMapPro<K, V> extends AbstractMapPro<K, V> implements Serializable {
     ...
     */
    public ConcurrentHashMapPro(int initialCapacity, float loadFactor, int concurrencyLevel) {
     ...
     * @since 1.6
     */
    public ConcurrentHashMapPro(int initialCapacity, float loadFactor) {
     ...
     */
    public ConcurrentHashMapPro(int initialCapacity) {
	...
	public void remove() {
	    ...
	    ConcurrentHashMapPro.this.remove(lastReturned.key);
	    lastReturned = null;
	}
    }
	...
	public V setValue(V value) {
	    ...
	    ConcurrentHashMapPro.this.put(getKey(), value);
	    return v;
	}
    }
	...
	@Override
	public int size() {
	    return ConcurrentHashMapPro.this.size();
	}

	@Override
	public boolean isEmpty() {
	    return ConcurrentHashMapPro.this.isEmpty();
	}

	@Override
	public boolean contains(Object o) {
	    return ConcurrentHashMapPro.this.containsKey(o);
	}
	...
	@Override
	public void clear() {
	    ConcurrentHashMapPro.this.clear();
	}
    }
	...
	@Override
	public boolean contains(Object o) {
	    return ConcurrentHashMapPro.this.containsValue(o);
	}
	...
	public boolean contains(Object o) {
	    ...
	    try {
		V v = ConcurrentHashMapPro.this.ge(e.getKey());
		if (v == null) {
	...
	public boolean remove(Object o) {
	    if (!(o instanceof Map.Entry)) return false;
	    Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
	    return ConcurrentHashMapPro.this.remove(e);
	}
