 ...
 */
public class KeyConcurrentHashMapPro<V> extends AbstractMapPro<lucee.runtime.type.Collection.Key, V> implements Serializable {
	 ...
	 */
	public KeyConcurrentHashMapPro(int initialCapacity, float loadFactor, int concurrencyLevel) {
	...
	final class KeyIterator extends HashIterator implements Iterator<lucee.runtime.type.Collection.Key>, Enumeration<lucee.runtime.type.Collection.Key> {
		@Override
		public lucee.runtime.type.Collection.Key next() {
			return super.nextEntry().key;
		}

		@Override
		public lucee.runtime.type.Collection.Key nextElement() {
			return super.nextEntry().key;
		}
	}
	 ...
	 * map.
	 */
	final class WriteThroughEntry extends AbstractMap.SimpleEntry<lucee.runtime.type.Collection.Key, V> {
	...
	final class EntryIterator extends HashIterator implements Iterator<Entry<lucee.runtime.type.Collection.Key, V>> {
		@Override
