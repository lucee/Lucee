 ...
 */
public final class ConcurrentHashMapNullSupportLegacy<K, V> extends AbstractMap<K, V> implements Serializable {
	 ...
	 */
	public ConcurrentHashMapNullSupportLegacy(int initialCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 * @since 1.6
	 */
	public ConcurrentHashMapNullSupportLegacy(int initialCapacity, float loadFactor) {
	 ...
	 */
	public ConcurrentHashMapNullSupportLegacy(int initialCapacity) {
	 ...
	 * concurrencyLevel (16).
	 */
	public ConcurrentHashMapNullSupportLegacy() {
	 ...
	 * @param m the map
	 */
	public ConcurrentHashMapNullSupportLegacy(Map<? extends K, ? extends V> m) {
	...
	abstract class HashIterator {
		...
		public void remove() {
			...
			ConcurrentHashMapNullSupportLegacy.this.remove(lastReturned.key);
			lastReturned = null;
		}
	}
	...
	final class WriteThroughEntry extends AbstractMap.SimpleEntry<K, V> {
		...
		public V setValue(V value) {
			...
			ConcurrentHashMapNullSupportLegacy.this.put(getKey(), value);
			return v;
		}
	}
	...
	final class KeySet extends AbstractSet<K> {
		...
		@Override
		public int size() {
			return ConcurrentHashMapNullSupportLegacy.this.size();
		}

		@Override
		public boolean isEmpty() {
			return ConcurrentHashMapNullSupportLegacy.this.isEmpty();
		}

		@Override
		public boolean contains(Object o) {
			return ConcurrentHashMapNullSupportLegacy.this.containsKey(o);
		}

		@Override
		public boolean remove(Object o) {
			try {
				ConcurrentHashMapNullSupportLegacy.this.rem(o);
				return true;
			}
			catch (Throwable t) {
		...
		@Override
		public void clear() {
			ConcurrentHashMapNullSupportLegacy.this.clear();
		}
	}
	...
	final class Values extends AbstractCollection<V> {
		...
		@Override
		public boolean contains(Object o) {
			return ConcurrentHashMapNullSupportLegacy.this.containsValue(o);
		}
	...
	final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
		...
		public boolean remove(Object o) {
			if (!(o instanceof Map.Entry)) return false;
			Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
			return ConcurrentHashMapNullSupportLegacy.this.remove(e);
		}
