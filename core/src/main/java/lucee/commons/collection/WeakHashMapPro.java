...
public class WeakHashMapPro<K, V> extends AbstractMapPro<K, V> implements MapPro<K, V> {
    ...
    /**
     * Constructs a new, empty <tt>WeakHashMap</tt> with the given initial capacity and the given load
     * factor.
     *
    ...
    /**
     * Constructs a new, empty <tt>WeakHashMap</tt> with the given initial capacity and the default load
     * factor (0.75).
     *
     * @param initialCapacity The initial capacity of the <tt>WeakHashMap</tt>
    ...
    /**
     * Constructs a new, empty <tt>WeakHashMap</tt> with the default initial capacity (16) and load
     * factor (0.75).
     */
    ...
    /**
     * Constructs a new <tt>WeakHashMap</tt> with the same mappings as the specified map. The
     * <tt>WeakHashMap</tt> is created with the default load factor (0.75) and an initial capacity
	...
	int h;
	/*
	 * if (useAltHashing) { h = hashSeed; if (k instanceof String) { return
	 * Hashing.stringHash32((String) k); } h ^= k.hashCode();
	 * 
	 * } else { h = k.hashCode(); }
	 */
	h = k.hashCode();
    ...
    /**
     * Returns <tt>true</tt> if this map contains no key-value mappings. This result is a snapshot, and
    ...
    /**
     * Returns the entry associated with the specified key in this map. Returns null if the map contains
     ...
     * map contains a mapping from key <tt>k</tt> to value <tt>v</tt> such that
     ...
     * contained no mapping for the key. A return value of <tt>null</tt> does not <i>necessarily</i>
