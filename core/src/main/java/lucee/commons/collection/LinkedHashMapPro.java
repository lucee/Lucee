...
public class LinkedHashMapPro<K, V> extends HashMapPro<K, V> implements MapPro<K, V> {
    ...
    /**
     * Constructs an empty insertion-ordered <tt>LinkedHashMap</tt> instance with the specified initial
    ...
    /**
     * Constructs an empty insertion-ordered <tt>LinkedHashMap</tt> instance with the default initial
     ...
     * specified map. The <tt>LinkedHashMap</tt> instance is created with a default load factor (0.75)
     ...
     *             nonpositive
     */
    public LinkedHashMapPro(int initialCapacity, float loadFactor, boolean accessOrder) {
	super(initialCapacity, loadFactor);
    ...
    /**
     * Transfers all entries to new table array. This method is called by superclass resize. It is
     * overridden for performance, as it is faster to iterate using our linked list.
     */
    @Override
	...
	for (HashMapPro.Entry<K, V> e = table[indexFor(hash, table.length)]; e != null; e = e.next) {
	    Object k;
    ...
    /**
     * This override alters behavior of superclass put method. It causes newly allocated entry to get
