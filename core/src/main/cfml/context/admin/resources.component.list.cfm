...
#component.componentDumpTemplate#">
				...
				Available formats include CFML, JSON, WDDX and plain text, catering to different data parsing and presentation needs. Additionally, this global setting can be overridden in the application.cfc using the this.returnFormat setting or directly within the function itself via the returnFormat attribute, providing flexibility for specific use cases.">
				<tr>
