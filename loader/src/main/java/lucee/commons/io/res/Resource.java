...
public interface Resource extends Serializable {
	 ...
	 *         contains a resource denoted by this abstract pathname
	 *         <em>and</em> the application is allowed to write to the resource;
	 ...
	 * when argument "force" is set to false, when argument "force" is set to
	 * true,
	 ...
	 * 
	 * @return The absolute abstract pathname denoting the same resource as this
	 *         abstract pathname
	 */
	 ...
	 * 
	 * @return The absolute pathname string denoting the same resource as this
	 *         abstract pathname
	 * 
	 */
	 ...
	 * 
	 * @return The canonical pathname string denoting the same resource as this
	 *         abstract pathname
	 * 
	 * @throws IOException
	 ...
	 * canonical form. Every pathname that denotes a nonexistent resource also
	 * has a unique canonical form. The canonical form of the pathname of a
	 * nonexistent file or directory may be different from the canonical form of
	 * the same pathname after the resource is created. Similarly, the canonical
	 * form of the pathname of an existing resource may be different from the
	 * canonical form of the same pathname after the resource is deleted.
	 * 
	 ...
	 * is <code>null</code> then all names are accepted.
	 ...
	 * parent directories.
	 * 
	 * @param createParentWhenNotExists throws Exception when can't create
	 *            directory
	 * @throws IOException
	 * 
	 */
	 ...
	 * 
	 * @param value
	 * @throws IOException throwed when no access to change the value or the
