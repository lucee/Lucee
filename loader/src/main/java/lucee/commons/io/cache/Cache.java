...
public interface Cache {
	...
	/**
	 * puts a cache entry to the cache, overwrite existing entries that already
	 * exists inside the cache with the same key
	 * 
	 * @param value
	 */
	...
	/**
	 * 
	 * Returns a List of the keys contained in this cache that match the given
	 * filter.
	 * The set is NOT backed by the cache, so changes to the cache are NOT
	 * reflected in the set, and vice-versa.
	 * 
	...
	/**
	 * Returns a List of entries containing in this cache Each element in the
	 * returned list is a CacheEntry.
	 * The set is NOT backed by the cache, so changes to the cache are NOT
	 * reflected in the set, and vice-versa.
	 * 
	 * @return a set of the entries contained in this cache.
	...
	/**
	 * Returns a list of entries containing in this cache that match the given
	 * filter.
