...
public interface NamingStrategy {
	...
	/**
	 * Defines the table name to be used for a specified table name. The
	 * specified table name is either
	 ...
	 * the column name specified in the mapping or chosen using the property
	 * name.
	 */
