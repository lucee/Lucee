...
public interface ORMUtil {
	 ...
	 * 
	 * @param pc
	 * @param force if set to false the engine is on loaded when the
	...
	public Object getPropertyValue(Component cfc, String name,
			Object defaultValue);
	...
	public DataSource getDefaultDataSource(PageContext pc,
	 ...
	 * @param defaultValue
	 */
	public DataSource getDataSource(PageContext pc, Component cfc,
			DataSource defaultValue);
	...
	public String getDataSourceName(PageContext pc, Component cfc)
			throws PageException;
