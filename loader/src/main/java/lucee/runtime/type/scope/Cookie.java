...
public interface Cookie extends Scope, UserScope {
	 ...
	 * @param expires expirs of the cookie (Date, number in seconds or keyword
	 *            as string )
	 ...
	 * @param path path of the cookie
	 * @param domain domain of the cookie
	 * @param httpOnly if true, sets cookie as httponly so that it cannot be
	 *            accessed using JavaScripts. Note that the browser must have
