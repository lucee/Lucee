...
public interface JavaSettings {
	...
	/**
	 * Indicates whether to reload the updated classes and JARs dynamically,
	 * without restarting ColdFusion.
	 * The default value is false
	 * 
	 * @return
	 */
	...
	/**
	 * Specifies the time interval in seconds after which to verify any change
	 * in the class files or JAR files.
