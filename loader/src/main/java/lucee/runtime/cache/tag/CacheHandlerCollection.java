...
public interface CacheHandlerCollection {
	 ...
	 * @return
	 */
	public CacheHandler getInstanceMatchingObject(Object cachedWithin,
			CacheHandler defaultValue);

	/**
	 * 
	 * @param cacheHandlerId id returned by CacheHandler.id() can be for example
	 *            (request,timespan,...)
	 * @return
	 */
	public CacheHandler getInstance(String cacheHandlerId,
			CacheHandler defaultValue);
