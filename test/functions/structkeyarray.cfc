component extends="org.lucee.cfml.test.LuceeTestCase"	{
	function run( testResults , testBox ) {
		...
		describe( title="Test suite for structUpdate", body=function() {
			it( title='Test case for structUpdate in function',body=function( currentSpec ) {
			...
			it( title='Test case for structUpdate in member-function',body=function( currentSpec ) {
