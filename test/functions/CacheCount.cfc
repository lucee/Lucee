 ...
 * 
 ---><cfcomponent extends="org.lucee.cfml.test.LuceeTestCase">
	...
	<cffunction name="testCacheCountEHCache" localMode="modern">
		<cfset createEHCache()>
	...
	<cffunction name="testCacheCountRedisCache" localMode="modern">
	...
	<cffunction access="private" name="testCacheCount" localMode="modern">
