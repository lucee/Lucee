component extends="org.lucee.cfml.test.LuceeTestCase"{
	...
	function run( testResults, testBox ){
		describe( "test case for ImageDrawPoint", function() {
			it(title = "Checking with ImageDrawPoint with imageURL", body = function( currentSpec ){
			...
			it(title = "Checking with image.drawOval() with imageURL in member function", body = function( currentSpec ){
			...
			it(title = "Checking with image.drawOval() in member function", body = function( currentSpec ){
