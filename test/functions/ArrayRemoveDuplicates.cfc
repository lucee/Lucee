component extends="org.lucee.cfml.test.LuceeTestCase"{
    ...
    function beforeAll() {
        ...
        variables.a1ref = a1;
        variables.a2 = [2];
        variables.base = [s,i,f,st1,st1bis,st1ref,st2,a1,a1bis,a1ref,a2,s,i,f,st1,st1bis,st1ref,st2,a1,a1bis,a1ref,a2];
    }
    ...
    function run( testResults, testBox ) {
        describe("Test suite for ArrayRemoveDuplicates()", function() {
            it(title="Checking ArrayRemoveDuplicates() function", body=function( currentSpec ) {
                assertEquals('["a string",42,3.14159265359,{"KEY1":"value1","KEY2":"value2"},{"KEY1":"VAlue1","KEY2":"value2"},{"KEY2":"value2"},[1],[2]]', serializeJSON(ArrayRemoveDuplicates(base)));
                assertEquals('["a string",42,3.14159265359,{"KEY1":"value1","KEY2":"value2"},{"KEY2":"value2"},[1],[2]]', serializeJSON(ArrayRemoveDuplicates(base, true)));
            ...
            it(title="Checking ArrayRemoveDuplicates() member function", body=function( currentSpec ) {
                assertEquals('["a string",42,3.14159265359,{"KEY1":"value1","KEY2":"value2"},{"KEY1":"VAlue1","KEY2":"value2"},{"KEY2":"value2"},[1],[2]]', serializeJSON(base.removeDuplicates()));
                assertEquals('["a string",42,3.14159265359,{"KEY1":"value1","KEY2":"value2"},{"KEY2":"value2"},[1],[2]]', serializeJSON(base.removeDuplicates(true)));
