component {
	...
	public function onRequestStart(){
		query{
			echo("DROP TABLE IF EXISTS ldev2298");
		}
		query{
			echo("CREATE TABLE ldev2298( id int, employee varchar(20), emp_join_date datetime )");
		}
		query{
			echo("INSERT INTO ldev2298 VALUES( 1,'testcase','2019-06-19' )");
		}
	}	
