component extends="org.lucee.cfml.test.LuceeTestCase" {
    function run() {
        describe("Test suite for LDEV-1297", function(){
            ...
            describe("checking arraysort() with BIF comparators", function(){
                ...
                it("checking with compareNoCase BIF as a string comparator when sorting", function(){
            ...
            describe("checking listsort() with BIF comparators", function(){
                it("checking with function expression calling compareNoCase as a string comparator when sorting", function(){
