component extends="org.lucee.cfml.test.LuceeTestCase"{
	...
	function run(){
		describe( title="Test cases for LDEV-1201", body=function(){
			...
			xit(title="Checking elvis operator value return by a function", body=function(){
				var result = "";
				try{
			...
			xit(title="test().notexisting?:'DF'", body=function(){
				var result = "";
				try{
			...
			xit(title="notexisting()?:'DF'", body=function(){
				var result = "";
				try{
			...
			xit(title="notexisting().a?:'DF'", body=function(){
				var result = "";
				try{
