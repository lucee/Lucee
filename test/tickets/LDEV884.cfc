	...
	function run( testResults , testBox ) {
		describe( "Test Case for LDEV-884", function() {
			...
			it( title='Checking DateDiff with a datepart of wd 2', body=function( currentSpec ) {
				var w = dateDiff("wd","2018-01-09","2019-01-16");
				expect(w).toBe('266');
			});
