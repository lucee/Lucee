...
component extends="org.lucee.cfml.test.LuceeTestCase"	{
	...
	/*
	virola.viviotech.net/205.210.189.210
	10022
	root
	Eunn:.TidkiWaj3
	null
	*/
	...
	public function testSFTP() {
	    ...
	    sftp={
	        server:"virola.viviotech.net",
	        port:10022,
	        username:"root",
	        password:"Eunn:.TidkiWaj3",
	        base:"/var/www/sites/updateprovider/dev/download"
	    };
	    _test(
	        secure:true,
	        host:sftp.server,
	...
	public function testFTP() {
		...
		ftp={
			server:"ftp53.world4you.com",
	        username:"ftp6390641",
	        password:"lamiinne0815",
	        port:21,
	        base:"/"
		};
	    _test(
